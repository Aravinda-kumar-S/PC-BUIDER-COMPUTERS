    ...
    <div className="bk-page">
      ...
      <section className="bkp-hero">
        ...
        <div className="bkp-logo-wrap">
          <img src="/bookkeeper-logo.png" alt="BookKeeper" className="bkp-logo-img" />
        </div>
        ...
        <div className="bkp-product-wrap">
          <img src="/bookkeeper-product.jpg" alt="BookKeeper – Now in 30+ Countries" className="bkp-product-img" />
        </div>
